...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("UntitledGameJamEntry", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("UntitledGameJamEntry", null, 1024, 768);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "67";
		app.meta["company"] = "FuckassCorp";
		app.meta["file"] = "UntitledGameJamEntry";
		app.meta["name"] = "Untitled Game Jam Entry";
		...
		#elseif air
		app.window.title = "Untitled Game Jam Entry";
		#else
