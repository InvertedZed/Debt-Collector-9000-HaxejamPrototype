...
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_482_new,"openfl.utils._Dictionary.UtilsObjectMap","new",0xb7b17cf2,"openfl.utils._Dictionary.UtilsObjectMap.new","openfl/utils/Dictionary.hx",482,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_488_clear,"openfl.utils._Dictionary.UtilsObjectMap","clear",0xd3eae69f,"openfl.utils._Dictionary.UtilsObjectMap.clear","openfl/utils/Dictionary.hx",488,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_494_copy,"openfl.utils._Dictionary.UtilsObjectMap","copy",0xfc5e0ee3,"openfl.utils._Dictionary.UtilsObjectMap.copy","openfl/utils/Dictionary.hx",494,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_504_exists,"openfl.utils._Dictionary.UtilsObjectMap","exists",0x51d7188a,"openfl.utils._Dictionary.UtilsObjectMap.exists","openfl/utils/Dictionary.hx",504,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_509_get,"openfl.utils._Dictionary.UtilsObjectMap","get",0xb7ac2d28,"openfl.utils._Dictionary.UtilsObjectMap.get","openfl/utils/Dictionary.hx",509,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_515_keyValueIterator,"openfl.utils._Dictionary.UtilsObjectMap","keyValueIterator",0xf84f2d8e,"openfl.utils._Dictionary.UtilsObjectMap.keyValueIterator","openfl/utils/Dictionary.hx",515,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_521_keys,"openfl.utils._Dictionary.UtilsObjectMap","keys",0x01a03522,"openfl.utils._Dictionary.UtilsObjectMap.keys","openfl/utils/Dictionary.hx",521,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_526_iterator,"openfl.utils._Dictionary.UtilsObjectMap","iterator",0xcd47cc1c,"openfl.utils._Dictionary.UtilsObjectMap.iterator","openfl/utils/Dictionary.hx",526,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_531_remove,"openfl.utils._Dictionary.UtilsObjectMap","remove",0x967f96f2,"openfl.utils._Dictionary.UtilsObjectMap.remove","openfl/utils/Dictionary.hx",531,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_536_set,"openfl.utils._Dictionary.UtilsObjectMap","set",0xb7b54834,"openfl.utils._Dictionary.UtilsObjectMap.set","openfl/utils/Dictionary.hx",536,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_541_toString,"openfl.utils._Dictionary.UtilsObjectMap","toString",0x721c52da,"openfl.utils._Dictionary.UtilsObjectMap.toString","openfl/utils/Dictionary.hx",541,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_476_boot,"openfl.utils._Dictionary.UtilsObjectMap","boot",0xfbb4d760,"openfl.utils._Dictionary.UtilsObjectMap.boot","openfl/utils/Dictionary.hx",476,0x5979b1eb)
namespace openfl{
namespace utils{
namespace _Dictionary{

void UtilsObjectMap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_482_new)
HXDLIN( 482)		this->map =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
            	}
...
static ::haxe::IMap_obj _hx_openfl_utils__Dictionary_UtilsObjectMap__hx_haxe_IMap= {
	...
	( ::String (::hx::Object::*)())&::openfl::utils::_Dictionary::UtilsObjectMap_obj::toString,
};
...
void UtilsObjectMap_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_488_clear)
HXDLIN( 488)		this->map->clear();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,clear,(void))
 ...
 ::openfl::utils::_Dictionary::UtilsObjectMap UtilsObjectMap_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_494_copy)
HXLINE( 495)		 ::openfl::utils::_Dictionary::UtilsObjectMap copied =  ::openfl::utils::_Dictionary::UtilsObjectMap_obj::__alloc( HX_CTX );
HXLINE( 496)		{
HXLINE( 496)			 ::Dynamic key = this->keys();
HXDLIN( 496)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 496)				 ::Dynamic key1 = key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXLINE( 497)				copied->set(key1,this->get(key1));
            			}
            		}
HXLINE( 498)		return copied;
            	}
...
bool UtilsObjectMap_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_504_exists)
HXDLIN( 504)		return this->map->exists(key);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(UtilsObjectMap_obj,exists,return )
 ...
 ::Dynamic UtilsObjectMap_obj::get( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_509_get)
HXDLIN( 509)		return this->map->get(key);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(UtilsObjectMap_obj,get,return )
 ...
 ::Dynamic UtilsObjectMap_obj::keyValueIterator(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_515_keyValueIterator)
HXDLIN( 515)		return  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,keyValueIterator,return )
 ...
 ::Dynamic UtilsObjectMap_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_521_keys)
HXDLIN( 521)		return this->map->keys();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,keys,return )
 ...
 ::Dynamic UtilsObjectMap_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_526_iterator)
...
bool UtilsObjectMap_obj::remove( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_531_remove)
HXDLIN( 531)		return this->map->remove(key);
            	}
...
void UtilsObjectMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_536_set)
HXDLIN( 536)		this->map->set(key,value);
            	}
...
::String UtilsObjectMap_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_541_toString)
HXDLIN( 541)		return this->map->toString();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_476_boot)
HXDLIN( 476)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
