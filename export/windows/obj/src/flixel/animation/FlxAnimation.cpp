...
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_248_getCurrentFrameDuration,"flixel.animation.FlxAnimation","getCurrentFrameDuration",0x83ef97be,"flixel.animation.FlxAnimation.getCurrentFrameDuration","flixel/animation/FlxAnimation.hx",248,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_255_clone,"flixel.animation.FlxAnimation","clone",0x4847dabd,"flixel.animation.FlxAnimation.clone","flixel/animation/FlxAnimation.hx",255,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_259_set_frameRate,"flixel.animation.FlxAnimation","set_frameRate",0x8699eef0,"flixel.animation.FlxAnimation.set_frameRate","flixel/animation/FlxAnimation.hx",259,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_266_set_curFrame,"flixel.animation.FlxAnimation","set_curFrame",0x46812eaa,"flixel.animation.FlxAnimation.set_curFrame","flixel/animation/FlxAnimation.hx",266,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_295_get_numFrames,"flixel.animation.FlxAnimation","get_numFrames",0x65f5f5c3,"flixel.animation.FlxAnimation.get_numFrames","flixel/animation/FlxAnimation.hx",295,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_300_get_delay,"flixel.animation.FlxAnimation","get_delay",0xe09c2b3a,"flixel.animation.FlxAnimation.get_delay","flixel/animation/FlxAnimation.hx",300,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_305_set_delay,"flixel.animation.FlxAnimation","set_delay",0xc3ed1746,"flixel.animation.FlxAnimation.set_delay","flixel/animation/FlxAnimation.hx",305,0x660bc6ae)
namespace flixel{
namespace animation{
...
HXLINE( 161)			this->parent->fireFinishCallback(this->name);
            		}
            	}
...
HXLINE( 218)					this->set_curFrame((this->frames->length - 1));
HXLINE( 219)					this->parent->fireLoopCallback(this->name);
            				}
            				else {
HXLINE( 223)					this->set_curFrame((this->curFrame - 1));
            				}
            			}
            			else {
HXLINE( 228)				bool _hx_tmp6;
HXDLIN( 228)				if (this->looped) {
HXLINE( 228)					_hx_tmp6 = (this->curFrame == (this->frames->length - 1));
            				}
            				else {
HXLINE( 228)					_hx_tmp6 = false;
            				}
HXDLIN( 228)				if (_hx_tmp6) {
HXLINE( 230)					this->set_curFrame(this->loopPoint);
HXLINE( 231)					this->parent->fireLoopCallback(this->name);
            				}
            				else {
HXLINE( 235)					this->set_curFrame((this->curFrame + 1));
            				}
            			}
HXLINE( 240)			if (this->finished) {
HXLINE( 241)				goto _hx_goto_10;
            			}
HXLINE( 243)			curFrameDuration = this->getCurrentFrameDuration();
            		}
            		_hx_goto_10:;
            	}
...
Float FlxAnimation_obj::getCurrentFrameDuration(){
            	HX_STACKFRAME(&_hx_pos_4744c2053d08e87b_248_getCurrentFrameDuration)
HXLINE( 249)		Float curframeDuration = this->parent->getFrameDuration(this->frames->__get(this->curFrame));
HXLINE( 250)		if ((curframeDuration > 0)) {
HXLINE( 250)			return curframeDuration;
            		}
            		else {
HXLINE( 250)			return this->frameDuration;
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxAnimation_obj,getCurrentFrameDuration,return )
 ...
 ::flixel::animation::FlxBaseAnimation FlxAnimation_obj::clone( ::flixel::animation::FlxAnimationController newParent){
            	HX_GC_STACKFRAME(&_hx_pos_4744c2053d08e87b_255_clone)
HXDLIN( 255)		return  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,newParent,this->name,this->frames,this->frameRate,this->looped,this->flipX,this->flipY);
            	}


Float FlxAnimation_obj::set_frameRate(Float value){
            	HX_STACKFRAME(&_hx_pos_4744c2053d08e87b_259_set_frameRate)
HXLINE( 260)		this->frameRate = value;
HXLINE( 261)		Float _hx_tmp;
HXDLIN( 261)		if ((value > 0)) {
HXLINE( 261)			_hx_tmp = (((Float)1.0) / value);
            		}
            		else {
HXLINE( 261)			_hx_tmp = ( (Float)(0) );
            		}
HXDLIN( 261)		this->frameDuration = _hx_tmp;
...
int FlxAnimation_obj::set_curFrame(int frame){
            	HX_STACKFRAME(&_hx_pos_4744c2053d08e87b_266_set_curFrame)
HXLINE( 267)		int maxFrameIndex = (this->frames->length - 1);
HXLINE( 268)		int tempFrame;
HXDLIN( 268)		if (this->reversed) {
HXLINE( 268)			tempFrame = (maxFrameIndex - frame);
            		}
            		else {
HXLINE( 268)			tempFrame = frame;
            		}
HXLINE( 270)		if ((tempFrame >= 0)) {
HXLINE( 272)			bool _hx_tmp;
HXDLIN( 272)			if (!(this->looped)) {
HXLINE( 272)				_hx_tmp = (tempFrame > maxFrameIndex);
            			}
            			else {
HXLINE( 272)				_hx_tmp = false;
            			}
HXDLIN( 272)			if (_hx_tmp) {
HXLINE( 274)				this->finished = true;
HXLINE( 275)				int _hx_tmp1;
HXDLIN( 275)				if (this->reversed) {
HXLINE( 275)					_hx_tmp1 = 0;
            				}
            				else {
HXLINE( 275)					_hx_tmp1 = maxFrameIndex;
            				}
HXDLIN( 275)				this->curFrame = _hx_tmp1;
            			}
            			else {
HXLINE( 279)				this->curFrame = frame;
            			}
            		}
            		else {
HXLINE( 283)			this->curFrame = ::flixel::FlxG_obj::random->_hx_int(0,maxFrameIndex,null());
            		}
HXLINE( 285)		this->set_curIndex(this->frames->__get(this->curFrame));
HXLINE( 287)		bool _hx_tmp2;
HXDLIN( 287)		if (this->finished) {
HXLINE( 287)			_hx_tmp2 = ::hx::IsNotNull( this->parent );
            		}
            		else {
HXLINE( 287)			_hx_tmp2 = false;
            		}
HXDLIN( 287)		if (_hx_tmp2) {
HXLINE( 288)			this->parent->fireFinishCallback(this->name);
            		}
HXLINE( 290)		return frame;
            	}
...
int FlxAnimation_obj::get_numFrames(){
            	HX_STACKFRAME(&_hx_pos_4744c2053d08e87b_295_get_numFrames)
HXDLIN( 295)		return this->frames->length;
            	}
...
Float FlxAnimation_obj::get_delay(){
            	HX_STACKFRAME(&_hx_pos_4744c2053d08e87b_300_get_delay)
HXDLIN( 300)		return this->frameDuration;
            	}
...
Float FlxAnimation_obj::set_delay(Float value){
            	HX_STACKFRAME(&_hx_pos_4744c2053d08e87b_305_set_delay)
HXDLIN( 305)		return (this->frameDuration = value);
            	}
