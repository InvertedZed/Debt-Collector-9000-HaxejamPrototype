...
HX_LOCAL_STACK_FRAME(_hx_pos_514496ecbc505000_84_updateSkewMatrix,"flixel.addons.effects.FlxSkewedSprite","updateSkewMatrix",0xa5318e37,"flixel.addons.effects.FlxSkewedSprite.updateSkewMatrix","flixel/addons/effects/FlxSkewedSprite.hx",84,0x49cdf014)
HX_LOCAL_STACK_FRAME(_hx_pos_514496ecbc505000_96_isSimpleRender,"flixel.addons.effects.FlxSkewedSprite","isSimpleRender",0xa32bc355,"flixel.addons.effects.FlxSkewedSprite.isSimpleRender","flixel/addons/effects/FlxSkewedSprite.hx",96,0x49cdf014)
namespace flixel{
namespace addons{
namespace effects{
...
HXLINE(  17)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE(  43)		this->skew = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->skew)) );
...
HXLINE(  74)		{
HXLINE(  74)			 ::flixel::math::FlxBasePoint this1 = this->getScreenPosition(this->_point,camera);
HXDLIN(  74)			 ::flixel::math::FlxBasePoint point = this->offset;
HXDLIN(  74)			{
HXLINE(  74)				Float y = point->y;
HXDLIN(  74)				this1->set_x((this1->x - point->x));
HXDLIN(  74)				this1->set_y((this1->y - y));
            			}
HXDLIN(  74)			{
HXLINE(  74)				 ::flixel::math::FlxBasePoint _this1 = point;
HXDLIN(  74)				if (_this1->_weak) {
HXLINE(  74)					_this1->put();
            				}
            			}
            		}
HXLINE(  75)		{
HXLINE(  75)			 ::flixel::math::FlxBasePoint this2 = this->_point;
HXDLIN(  75)			 ::flixel::math::FlxBasePoint point1 = this->origin;
HXDLIN(  75)			{
HXLINE(  75)				Float y1 = point1->y;
HXDLIN(  75)				this2->set_x((this2->x + point1->x));
HXDLIN(  75)				this2->set_y((this2->y + y1));
            			}
HXDLIN(  75)			{
HXLINE(  75)				 ::flixel::math::FlxBasePoint _this2 = point1;
HXDLIN(  75)				if (_this2->_weak) {
HXLINE(  75)					_this2->put();
            				}
            			}
            		}
HXLINE(  76)		if (this->isPixelPerfectRender(camera)) {
HXLINE(  77)			 ::flixel::math::FlxBasePoint this3 = this->_point;
HXDLIN(  77)			this3->set_x(( (Float)(::Math_obj::floor(this3->x)) ));
HXDLIN(  77)			this3->set_y(( (Float)(::Math_obj::floor(this3->y)) ));
            		}
HXLINE(  79)		this->_matrix->translate(this->_point->x,this->_point->y);
HXLINE(  80)		camera->drawPixels(this->_frame,this->framePixels,this->_matrix,this->colorTransform,this->blend,this->antialiasing,this->shader);
            	}


void FlxSkewedSprite_obj::updateSkewMatrix(){
            	HX_STACKFRAME(&_hx_pos_514496ecbc505000_84_updateSkewMatrix)
HXLINE(  85)		this->_skewMatrix->identity();
HXLINE(  87)		bool _hx_tmp;
HXDLIN(  87)		if ((this->skew->x == 0)) {
HXLINE(  87)			_hx_tmp = (this->skew->y != 0);
            		}
            		else {
HXLINE(  87)			_hx_tmp = true;
            		}
HXDLIN(  87)		if (_hx_tmp) {
HXLINE(  89)			this->_skewMatrix->b = ::Math_obj::tan((this->skew->y * (::Math_obj::PI / ( (Float)(180) ))));
HXLINE(  90)			this->_skewMatrix->c = ::Math_obj::tan((this->skew->x * (::Math_obj::PI / ( (Float)(180) ))));
            		}
            	}
...
bool FlxSkewedSprite_obj::isSimpleRender( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_514496ecbc505000_96_isSimpleRender)
HXDLIN(  96)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(  98)			bool _hx_tmp;
HXDLIN(  98)			bool _hx_tmp1;
HXDLIN(  98)			if (this->super::isSimpleRender(camera)) {
HXLINE(  98)				_hx_tmp1 = (this->skew->x == 0);
            			}
            			else {
HXLINE(  98)				_hx_tmp1 = false;
            			}
HXDLIN(  98)			if (_hx_tmp1) {
HXLINE(  98)				_hx_tmp = (this->skew->y == 0);
            			}
            			else {
HXLINE(  98)				_hx_tmp = false;
            			}
HXDLIN(  98)			if (_hx_tmp) {
HXLINE(  98)				return !(this->matrixExposed);
            			}
            			else {
