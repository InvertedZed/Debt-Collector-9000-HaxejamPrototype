...
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_625_destroy,"flixel.path.FlxTypedPathfinderData","destroy",0xefba5c10,"flixel.path.FlxTypedPathfinderData.destroy","flixel/path/FlxPathfinder.hx",625,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_640_isExcluded,"flixel.path.FlxTypedPathfinderData","isExcluded",0xe8c134fe,"flixel.path.FlxTypedPathfinderData.isExcluded","flixel/path/FlxPathfinder.hx",640,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_648_getX,"flixel.path.FlxTypedPathfinderData","getX",0xa2e32a2c,"flixel.path.FlxTypedPathfinderData.getX","flixel/path/FlxPathfinder.hx",648,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_656_getY,"flixel.path.FlxTypedPathfinderData","getY",0xa2e32a2d,"flixel.path.FlxTypedPathfinderData.getY","flixel/path/FlxPathfinder.hx",656,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_665_getTileCollisionsByIndex,"flixel.path.FlxTypedPathfinderData","getTileCollisionsByIndex",0x8a013ca0,"flixel.path.FlxTypedPathfinderData.getTileCollisionsByIndex","flixel/path/FlxPathfinder.hx",665,0x74454158)
namespace flixel{
namespace path{
...
HXDLIN( 620)		int mapIndex = this->startIndex;
HXDLIN( 620)		bool _hx_tmp;
HXDLIN( 620)		if ((mapIndex >= 0)) {
HXDLIN( 620)			_hx_tmp = (mapIndex < ( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->_data->length);
            		}
            		else {
HXDLIN( 620)			_hx_tmp = false;
            		}
HXDLIN( 620)		if (_hx_tmp) {
HXLINE( 621)			int mapIndex1 = this->endIndex;
HXDLIN( 621)			if ((mapIndex1 >= 0)) {
HXLINE( 621)				return (mapIndex1 < ( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->_data->length);
            			}
            			else {
...
void FlxTypedPathfinderData_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_625_destroy)
HXLINE( 626)		this->map = null();
HXLINE( 627)		this->distances = null();
HXLINE( 628)		this->moves = null();
HXLINE( 629)		this->excluded = null();
            	}
...
bool FlxTypedPathfinderData_obj::isExcluded(int index){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_640_isExcluded)
HXDLIN( 640)		return this->excluded->contains(index);
            	}
...
int FlxTypedPathfinderData_obj::getX(int tile){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_648_getX)
HXDLIN( 648)		return ::hx::Mod(tile,( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->widthInTiles);
            	}
...
int FlxTypedPathfinderData_obj::getY(int tile){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_656_getY)
HXDLIN( 656)		return ::Std_obj::_hx_int((( (Float)(tile) ) / ( (Float)(( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->widthInTiles) )));
            	}
...
int FlxTypedPathfinderData_obj::getTileCollisionsByIndex(int tile){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_665_getTileCollisionsByIndex)
HXDLIN( 665)		 ::Dynamic _this = this->map;
HXDLIN( 665)		int _hx_tmp;
HXDLIN( 665)		bool _hx_tmp1;
HXDLIN( 665)		if ((tile >= 0)) {
HXDLIN( 665)			_hx_tmp1 = (tile < ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->length);
            		}
            		else {
HXDLIN( 665)			_hx_tmp1 = false;
            		}
HXDLIN( 665)		if (_hx_tmp1) {
HXDLIN( 665)			_hx_tmp = ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->__get(tile);
            		}
            		else {
HXDLIN( 665)			_hx_tmp = -1;
            		}
HXDLIN( 665)		return Dynamic( ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_tileObjects->__get(_hx_tmp)).StaticCast<  ::flixel::FlxObject >()->allowCollisions;
            	}
