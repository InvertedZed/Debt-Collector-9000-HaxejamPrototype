...
HXDLIN( 437)				{
HXLINE( 437)					 ::flixel::math::FlxBasePoint _this = node;
HXDLIN( 437)					if (_this->_weak) {
HXLINE( 437)						_this->put();
            					}
            				}
...
HXDLIN( 437)				{
HXLINE( 437)					 ::flixel::math::FlxBasePoint _this1 = point;
HXDLIN( 437)					if (_this1->_weak) {
HXLINE( 437)						_this1->put();
            					}
            				}
