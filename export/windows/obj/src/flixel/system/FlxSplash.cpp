...
HXDLIN(  90)			_hx_tmp->load(::flixel::_hx_system::FlxAssets_obj::getSoundAddExtension(HX_("flixel/sounds/flixel",54,41,d6,5d),null()),null(),null(),null(),null(),null(),null(),null(),null())->play(null(),null(),null());
            		}
            	}
