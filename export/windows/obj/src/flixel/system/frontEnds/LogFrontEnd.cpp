...
HX_LOCAL_STACK_FRAME(_hx_pos_ba09e0c9e62cea6b_49_advanced,"flixel.system.frontEnds.LogFrontEnd","advanced",0x05a7fef4,"flixel.system.frontEnds.LogFrontEnd.advanced","flixel/system/frontEnds/LogFrontEnd.hx",49,0x686ab8c3)
HX_LOCAL_STACK_FRAME(_hx_pos_ba09e0c9e62cea6b_90_clear,"flixel.system.frontEnds.LogFrontEnd","clear",0x4a0034fb,"flixel.system.frontEnds.LogFrontEnd.clear","flixel/system/frontEnds/LogFrontEnd.hx",90,0x686ab8c3)
HX_LOCAL_STACK_FRAME(_hx_pos_ba09e0c9e62cea6b_103_set_redirectTraces,"flixel.system.frontEnds.LogFrontEnd","set_redirectTraces",0xf7f71199,"flixel.system.frontEnds.LogFrontEnd.set_redirectTraces","flixel/system/frontEnds/LogFrontEnd.hx",103,0x686ab8c3)
HX_LOCAL_STACK_FRAME(_hx_pos_ba09e0c9e62cea6b_115_processTraceData,"flixel.system.frontEnds.LogFrontEnd","processTraceData",0x5a916632,"flixel.system.frontEnds.LogFrontEnd.processTraceData","flixel/system/frontEnds/LogFrontEnd.hx",115,0x686ab8c3)
namespace flixel{
...
HXLINE(  99)		this->_standardTraceFunction = ::haxe::Log_obj::trace;
            	}
...
void LogFrontEnd_obj::advanced( ::Dynamic data, ::flixel::_hx_system::debug::log::LogStyle style,::hx::Null< bool >  __o_fireOnce){
            	...
            	HX_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_49_advanced)
HXLINE(  50)		if (::hx::IsNull( style )) {
HXLINE(  51)			style = ::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL;
            		}
HXLINE(  53)		::cpp::VirtualArray arrayData;
HXDLIN(  53)		if (!(::Std_obj::isOfType(data,::hx::ArrayBase::__mClass))) {
HXLINE(  53)			arrayData = ::cpp::VirtualArray_obj::__new(1)->init(0,data);
            		}
            		else {
HXLINE(  53)			arrayData = ( (::cpp::VirtualArray)(data) );
            		}
HXLINE(  80)		style->onLog->dispatch(data);
HXLINE(  82)		if (style->throwException) {
HXLINE(  83)			HX_STACK_DO_THROW(style->toLogString(arrayData));
            		}
            	}
...
void LogFrontEnd_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_90_clear)
            	}
...
bool LogFrontEnd_obj::set_redirectTraces(bool redirect){
            	HX_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_103_set_redirectTraces)
HXLINE( 104)		 ::Dynamic _hx_tmp;
HXDLIN( 104)		if (redirect) {
HXLINE( 104)			_hx_tmp = this->processTraceData_dyn();
            		}
            		else {
HXLINE( 104)			_hx_tmp = this->_standardTraceFunction;
            		}
HXDLIN( 104)		::haxe::Log_obj::trace = _hx_tmp;
HXLINE( 105)		return (this->redirectTraces = redirect);
            	}
...
void LogFrontEnd_obj::processTraceData( ::Dynamic data, ::Dynamic info){
            	HX_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_115_processTraceData)
HXLINE( 116)		::cpp::VirtualArray paramArray = ::cpp::VirtualArray_obj::__new(1)->init(0,data);
HXLINE( 118)		if (::hx::IsNotNull( info->__Field(HX_("customParams",d7,51,18,ed),::hx::paccDynamic) )) {
HXLINE( 120)			int _g = 0;
HXDLIN( 120)			::cpp::VirtualArray _g1 = ( (::cpp::VirtualArray)(info->__Field(HX_("customParams",d7,51,18,ed),::hx::paccDynamic)) );
HXDLIN( 120)			while((_g < _g1->get_length())){
HXLINE( 120)				 ::Dynamic i = _g1->__get(_g);
HXDLIN( 120)				_g = (_g + 1);
HXLINE( 122)				paramArray->push(i);
            			}
            		}
HXLINE( 126)		this->advanced(paramArray,::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            	}
