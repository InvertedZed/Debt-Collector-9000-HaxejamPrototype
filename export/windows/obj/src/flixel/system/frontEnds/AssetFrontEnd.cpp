...
HXDLIN( 188)				::flixel::FlxG_obj::log->advanced(((((HX_("",00,00,00,00) + type) + HX_(" asset \"",d2,25,2a,5d)) + id) + HX_("\" exists, but only asynchronously",dc,ca,f2,dd)),logStyle,null());
            			}
...
HXDLIN( 192)			::flixel::FlxG_obj::log->advanced(((((HX_("Could not find a ",5a,92,c9,f3) + type) + HX_(" asset with ID '",ac,22,56,0f)) + id) + HX_("'.",27,22,00,00)),logStyle,null());
            		}
