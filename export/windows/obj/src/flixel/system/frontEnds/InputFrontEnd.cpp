...
HX_LOCAL_STACK_FRAME(_hx_pos_ff18a02f3055fb45_38_addInput_game_ingame_PlayerControls,"flixel.system.frontEnds.InputFrontEnd","addInput_game_ingame_PlayerControls",0x72bb617c,"flixel.system.frontEnds.InputFrontEnd.addInput_game_ingame_PlayerControls","flixel/system/frontEnds/InputFrontEnd.hx",38,0x759f67bd)
...
bool InputFrontEnd_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::game::ingame::PlayerControls InputFrontEnd_obj::addInput_game_ingame_PlayerControls( ::game::ingame::PlayerControls input){
            	HX_STACKFRAME(&_hx_pos_ff18a02f3055fb45_38_addInput_game_ingame_PlayerControls)
...
HX_DEFINE_DYNAMIC_FUNC1(InputFrontEnd_obj,addInput_game_ingame_PlayerControls,return )
...
::hx::Val InputFrontEnd_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 19:
		...
		break;
	case 35:
		if (HX_FIELD_EQ(inName,"addInput_game_ingame_PlayerControls") ) { return ::hx::Val( addInput_game_ingame_PlayerControls_dyn() ); }
...
static ::String InputFrontEnd_obj_sMemberFields[] = {
	HX_("addInput_game_ingame_PlayerControls",88,37,ed,fc),
