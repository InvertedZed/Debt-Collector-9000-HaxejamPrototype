...
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_396_get_maxTextureSize,"flixel.system.frontEnds.BitmapFrontEnd","get_maxTextureSize",0x8d42ecd4,"flixel.system.frontEnds.BitmapFrontEnd.get_maxTextureSize","flixel/system/frontEnds/BitmapFrontEnd.hx",396,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_405_get_whitePixel,"flixel.system.frontEnds.BitmapFrontEnd","get_whitePixel",0xa476cef9,"flixel.system.frontEnds.BitmapFrontEnd.get_whitePixel","flixel/system/frontEnds/BitmapFrontEnd.hx",405,0x91a05ae2)
namespace flixel{
...
int BitmapFrontEnd_obj::get_maxTextureSize(){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_396_get_maxTextureSize)
HXLINE( 397)		if (( (bool)(::openfl::Lib_obj::get_current()->stage->window->context->attributes->__Field(HX_("hardware",a8,e2,d3,75),::hx::paccDynamic)) )) {
HXLINE( 398)			return ( (int)(::lime::graphics::opengl::GL_obj::context->getParameter(3379)) );
            		}
HXLINE( 400)		return -1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BitmapFrontEnd_obj,get_maxTextureSize,return )
 ...
 ::flixel::graphics::frames::FlxFrame BitmapFrontEnd_obj::get_whitePixel(){
            	HX_GC_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_405_get_whitePixel)
HXLINE( 406)		if (::hx::IsNull( this->_whitePixel )) {
HXLINE( 408)			 ::openfl::display::BitmapData bd =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,10,10,true,-1);
HXLINE( 409)			 ::flixel::graphics::FlxGraphic graphic = ::flixel::FlxG_obj::bitmap->add(bd,true,HX_("whitePixels",b6,92,ba,9e));
HXLINE( 410)			graphic->persist = true;
HXLINE( 411)			this->_whitePixel = graphic->get_imageFrame()->get_frame();
            		}
HXLINE( 414)		return this->_whitePixel;
            	}
