...
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1400_fromOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","fromOpenFL",0xc584ea03,"flixel.text._FlxText.FlxTextAlign_Impl_.fromOpenFL","flixel/text/FlxText.hx",1400,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1416_toOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","toOpenFL",0xa34e3094,"flixel.text._FlxText.FlxTextAlign_Impl_.toOpenFL","flixel/text/FlxText.hx",1416,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1386_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1386,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1393_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1393,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1395_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1395,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1396_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1396,0xdf165a6e)
namespace flixel{
namespace text{
namespace _FlxText{
...
::String FlxTextAlign_Impl__obj::fromOpenFL( ::Dynamic align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1400_fromOpenFL)
HXDLIN(1400)		if (::hx::IsNull( align )) {
HXLINE(1405)			return HX_("left",07,08,b0,47);
            		}
            		else {
HXDLIN(1400)			 ::Dynamic _hx_switch_0 = align;
            			if (  (_hx_switch_0==0) ){
HXLINE(1407)				return HX_("center",d5,25,db,05);
HXDLIN(1407)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==2) ){
HXLINE(1409)				return HX_("justify",50,df,b5,83);
HXDLIN(1409)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==3) ){
HXLINE(1406)				return HX_("left",07,08,b0,47);
HXDLIN(1406)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==4) ){
HXLINE(1408)				return HX_("right",dc,0b,64,e9);
HXDLIN(1408)				goto _hx_goto_0;
            			}
            			/* default */{
HXLINE(1410)				return HX_("left",07,08,b0,47);
            			}
            			_hx_goto_0:;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTextAlign_Impl__obj,fromOpenFL,return )
 ...
 ::Dynamic FlxTextAlign_Impl__obj::toOpenFL(::String align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1416_toOpenFL)
HXDLIN(1416)		::String _hx_switch_0 = align;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE(1419)			return 0;
HXDLIN(1419)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("justify",50,df,b5,83)) ){
HXLINE(1421)			return 2;
HXDLIN(1421)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE(1418)			return 3;
HXDLIN(1418)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE(1420)			return 4;
HXDLIN(1420)			goto _hx_goto_2;
            		}
            		/* default */{
HXLINE(1422)			return 3;
            		}
            		_hx_goto_2:;
...
{
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1386_boot)
HXDLIN(1386)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1393_boot)
HXDLIN(1393)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1395_boot)
HXDLIN(1395)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1396_boot)
HXDLIN(1396)		JUSTIFY = HX_("justify",50,df,b5,83);
            	}
}
