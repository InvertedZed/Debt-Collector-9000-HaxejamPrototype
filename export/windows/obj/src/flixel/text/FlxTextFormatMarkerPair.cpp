...
HX_DEFINE_STACK_FRAME(_hx_pos_415d3a020ae56400_1351_new,"flixel.text.FlxTextFormatMarkerPair","new",0xb549f24d,"flixel.text.FlxTextFormatMarkerPair.new","flixel/text/FlxText.hx",1351,0xdf165a6e)
namespace flixel{
namespace text{

void FlxTextFormatMarkerPair_obj::__construct( ::flixel::text::FlxTextFormat format,::String marker){
            	HX_STACKFRAME(&_hx_pos_415d3a020ae56400_1351_new)
HXLINE(1352)		this->format = format;
HXLINE(1353)		this->marker = marker;
            	}
