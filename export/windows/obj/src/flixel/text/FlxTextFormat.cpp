...
HX_DEFINE_STACK_FRAME(_hx_pos_a69907c6a733237a_1321_new,"flixel.text.FlxTextFormat","new",0x67be2279,"flixel.text.FlxTextFormat.new","flixel/text/FlxText.hx",1321,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_a69907c6a733237a_1327_set_leading,"flixel.text.FlxTextFormat","set_leading",0x68682d02,"flixel.text.FlxTextFormat.set_leading","flixel/text/FlxText.hx",1327,0xdf165a6e)
namespace flixel{
namespace text{

void FlxTextFormat_obj::__construct( ::Dynamic fontColor, ::Dynamic bold, ::Dynamic italic, ::Dynamic borderColor, ::Dynamic underline){
            	HX_GC_STACKFRAME(&_hx_pos_a69907c6a733237a_1321_new)
HXLINE(1322)		this->format =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,null(),null(),fontColor,bold,italic,underline,null(),null(),null(),null(),null(),null(),null());
HXLINE(1323)		int _hx_tmp;
HXDLIN(1323)		if (::hx::IsNull( borderColor )) {
HXLINE(1323)			_hx_tmp = 0;
            		}
            		else {
HXLINE(1323)			_hx_tmp = ( (int)(borderColor) );
            		}
HXDLIN(1323)		this->borderColor = _hx_tmp;
            	}
...
int FlxTextFormat_obj::set_leading(int value){
            	HX_STACKFRAME(&_hx_pos_a69907c6a733237a_1327_set_leading)
HXLINE(1328)		this->format->leading = value;
HXLINE(1329)		return value;
            	}
