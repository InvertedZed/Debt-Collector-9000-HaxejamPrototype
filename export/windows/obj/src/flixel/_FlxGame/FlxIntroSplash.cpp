...
HX_DEFINE_STACK_FRAME(_hx_pos_55d3e170e0a59f10_917_new,"flixel._FlxGame.FlxIntroSplash","new",0xa309920a,"flixel._FlxGame.FlxIntroSplash.new","flixel/FlxGame.hx",917,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_55d3e170e0a59f10_920_startOutro,"flixel._FlxGame.FlxIntroSplash","startOutro",0xa4b3c39f,"flixel._FlxGame.FlxIntroSplash.startOutro","flixel/FlxGame.hx",920,0x34f39fed)
namespace flixel{
namespace _FlxGame{

void FlxIntroSplash_obj::__construct( ::Dynamic nextState){
            	HX_STACKFRAME(&_hx_pos_55d3e170e0a59f10_917_new)
HXDLIN( 917)		super::__construct(nextState);
            	}
...
void FlxIntroSplash_obj::startOutro( ::Dynamic onOutroComplete){
            	HX_STACKFRAME(&_hx_pos_55d3e170e0a59f10_920_startOutro)
HXLINE( 921)		::flixel::FlxG_obj::game->_gameJustStarted = true;
HXLINE( 922)		this->super::startOutro(onOutroComplete);
            	}
