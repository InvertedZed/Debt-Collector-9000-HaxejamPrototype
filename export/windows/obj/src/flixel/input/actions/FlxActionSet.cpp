...
HXDLIN( 300)						::Array< ::Dynamic> _g3 = action->inputs;
HXDLIN( 300)						while((_g2 < _g3->length)){
HXLINE( 300)							 ::flixel::input::actions::FlxActionInput input = _g3->__get(_g2).StaticCast<  ::flixel::input::actions::FlxActionInput >();
...
HXDLIN( 152)				while((_g1 < arrA->get_length())){
HXLINE( 152)					 ::Dynamic a = arrA->__get(_g1);
HXDLIN( 152)					_g1 = (_g1 + 1);
HXLINE( 154)					::String aName = ( (::String)(a) );
HXLINE( 155)					 ::flixel::input::actions::FlxActionAnalog action1 =  ::flixel::input::actions::FlxActionAnalog_obj::__alloc( HX_CTX ,aName,CallbackAnalog);
HXLINE( 156)					analogActions->push(action1);
            				}
            			}
            		}
