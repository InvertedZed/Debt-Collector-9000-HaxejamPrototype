...
HXLINE( 271)		super::__construct(::flixel::input::actions::FlxInputDevice_obj::STEAM_CONTROLLER_dyn(),ActionHandle,Trigger,DeviceHandle);
HXLINE( 275)		::flixel::FlxG_obj::log->advanced(HX_("steamwrap library not installed; steam inputs will be ignored.",eb,58,1d,c7),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            	}
...
HXLINE( 284)					return true;
            			...
            			break;
            			case (int)1: {
HXLINE( 283)				 ::flixel::input::FlxInput _this1 = this->steamInput;
HXDLIN( 283)				bool _hx_tmp1;
HXDLIN( 283)				if ((_this1->current != 1)) {
HXLINE( 283)					_hx_tmp1 = (_this1->current == 2);
            				}
            				else {
