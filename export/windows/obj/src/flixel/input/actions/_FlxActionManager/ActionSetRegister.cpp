...
HXLINE( 641)					_hx_tmp1 = ActionSet;
            				}
            				else {
HXLINE( 641)					_hx_tmp1 = -1;
            				}
HXDLIN( 641)				this->keyboardSet = _hx_tmp1;
            			}
            			break;
            			case (int)4: {
...
HXLINE( 650)						this->clearSetFromArray(ActionSet,this->gamepadSets);
            					...
            					break;
            					case (int)-2: {
HXLINE( 654)						::Array< int > _hx_tmp2 = this->gamepadSets;
HXDLIN( 654)						int _hx_tmp3 = ::flixel::FlxG_obj::gamepads->getFirstActiveGamepadID();
HXDLIN( 654)						int _hx_tmp4;
HXDLIN( 654)						if (DoActivate) {
HXLINE( 654)							_hx_tmp4 = ActionSet;
            						}
            						else {
HXLINE( 654)							_hx_tmp4 = -1;
            						}
HXDLIN( 654)						_hx_tmp2[_hx_tmp3] = _hx_tmp4;
            					}
            					break;
            					case (int)-1: {
HXLINE( 646)						this->clearSetFromArray(-1,this->gamepadSets);
HXLINE( 647)						int _hx_tmp5;
HXDLIN( 647)						if (DoActivate) {
HXLINE( 647)							_hx_tmp5 = ActionSet;
            						}
            						else {
HXLINE( 647)							_hx_tmp5 = -1;
            						}
HXDLIN( 647)						this->gamepadAllSet = _hx_tmp5;
            					}
            					break;
            					default:{
HXLINE( 658)						int _hx_tmp6;
HXDLIN( 658)						if (DoActivate) {
HXLINE( 658)							_hx_tmp6 = ActionSet;
            						}
            						else {
HXLINE( 658)							_hx_tmp6 = -1;
            						}
HXDLIN( 658)						this->gamepadSets[DeviceID] = _hx_tmp6;
            					}
            				}
            			}
            			break;
...
HXLINE( 675)						this->clearSetFromArray(ActionSet,this->steamControllerSets);
            					...
            					break;
            					case (int)-2: {
HXLINE( 678)						::Array< int > _hx_tmp7 = this->steamControllerSets;
HXDLIN( 678)						int _hx_tmp8 = ::flixel::input::actions::FlxSteamController_obj::getFirstActiveHandle();
HXDLIN( 678)						int _hx_tmp9;
HXDLIN( 678)						if (DoActivate) {
HXLINE( 678)							_hx_tmp9 = ActionSet;
            						}
            						else {
HXLINE( 678)							_hx_tmp9 = -1;
            						}
HXDLIN( 678)						_hx_tmp7[_hx_tmp8] = _hx_tmp9;
            					}
            					break;
            					case (int)-1: {
HXLINE( 665)						int _hx_tmp10;
HXDLIN( 665)						if (DoActivate) {
HXLINE( 665)							_hx_tmp10 = ActionSet;
            						}
            						else {
HXLINE( 665)							_hx_tmp10 = -1;
            						}
HXDLIN( 665)						this->steamControllerAllSet = _hx_tmp10;
HXLINE( 666)						this->clearSetFromArray(-1,this->steamControllerSets);
            					}
            					break;
            					default:{
HXLINE( 681)						int _hx_tmp11;
HXDLIN( 681)						if (DoActivate) {
HXLINE( 681)							_hx_tmp11 = ActionSet;
            						}
            						else {
HXLINE( 681)							_hx_tmp11 = -1;
            						}
HXDLIN( 681)						this->steamControllerSets[DeviceID] = _hx_tmp11;
            					}
            				}
            			}
            			break;
...
HXLINE( 893)					_hx_tmp1 = (this->keyboardSet < sets->length);
            				}
            				else {
...
HXLINE( 897)					_hx_tmp2 = (this->gamepadAllSet < sets->length);
            				}
            				else {
...
HXLINE( 906)							_hx_tmp3 = (gset < sets->length);
            						}
            						else {
...
HXLINE( 915)					_hx_tmp4 = (this->steamControllerAllSet < sets->length);
            				}
            				else {
...
HXLINE( 921)					int _g2 = 0;
HXDLIN( 921)					int _g3 = this->steamControllerSets->length;
HXDLIN( 921)					while((_g2 < _g3)){
HXLINE( 921)						_g2 = (_g2 + 1);
HXDLIN( 921)						int i1 = (_g2 - 1);
HXLINE( 923)						int sset = this->steamControllerSets->__get(i1);
HXLINE( 924)						bool _hx_tmp5;
HXDLIN( 924)						if ((sset >= 0)) {
HXLINE( 924)							_hx_tmp5 = (sset < sets->length);
            						}
            						else {
