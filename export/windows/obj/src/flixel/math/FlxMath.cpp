...
HXLINE( 216)			return ::flixel::math::FlxMath_obj::pointInFlxRect(( (Float)(::flixel::FlxG_obj::mouse->viewX) ),( (Float)(::flixel::FlxG_obj::mouse->viewY) ),rect);
            		}
...
HXLINE( 401)		Float dx = ((Sprite->x + Sprite->origin->x) - ( (Float)(::flixel::FlxG_obj::mouse->viewX) ));
HXLINE( 402)		Float dy = ((Sprite->y + Sprite->origin->y) - ( (Float)(::flixel::FlxG_obj::mouse->viewY) ));
...
HXLINE( 417)		Float dx = ((Sprite->x + Sprite->origin->x) - ( (Float)(::flixel::FlxG_obj::mouse->viewX) ));
HXLINE( 418)		Float dy = ((Sprite->y + Sprite->origin->y) - ( (Float)(::flixel::FlxG_obj::mouse->viewY) ));
