...
HXDLIN( 202)		::cpp::VirtualArray imageFrames;
HXDLIN( 202)		if (::hx::IsNull( graphic->shader )) {
HXLINE( 202)			::flixel::FlxG_obj::log->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXDLIN( 202)			imageFrames = ::cpp::VirtualArray_obj::__new(0);
            		}
            		else {
HXLINE( 202)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(graphic->frameCollections->get(type)) );
...
HXDLIN( 202)			imageFrames = collections;
            		}
HXDLIN( 202)		::Array< ::Dynamic> imageFrames1 = imageFrames;
HXLINE( 203)		{
HXLINE( 203)			int _g = 0;
HXDLIN( 203)			while((_g < imageFrames1->length)){
HXLINE( 203)				 ::flixel::graphics::frames::FlxImageFrame imageFrame = imageFrames1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxImageFrame >();
HXDLIN( 203)				_g = (_g + 1);
...
HXDLIN( 231)		::cpp::VirtualArray imageFrames;
HXDLIN( 231)		if (::hx::IsNull( graphic->shader )) {
HXLINE( 231)			::flixel::FlxG_obj::log->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXDLIN( 231)			imageFrames = ::cpp::VirtualArray_obj::__new(0);
            		}
            		else {
HXLINE( 231)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(graphic->frameCollections->get(type)) );
...
HXDLIN( 231)			imageFrames = collections;
            		}
HXDLIN( 231)		::Array< ::Dynamic> imageFrames1 = imageFrames;
HXLINE( 233)		{
HXLINE( 233)			int _g = 0;
HXDLIN( 233)			while((_g < imageFrames1->length)){
HXLINE( 233)				 ::flixel::graphics::frames::FlxImageFrame imageFrame = imageFrames1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxImageFrame >();
HXDLIN( 233)				_g = (_g + 1);
