...
void FlxTileFrames_obj::__construct( ::flixel::graphics::FlxGraphic parent, ::flixel::math::FlxBasePoint border){
...
bool FlxTileFrames_obj::equals( ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxRect region, ::flixel::graphics::frames::FlxFrame atlasFrame, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint border){
...
HXDLIN( 500)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXLINE( 503)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 503)			point->_inPool = false;
HXDLIN( 503)			 ::flixel::math::FlxBasePoint point1 = point;
HXDLIN( 503)			point1->_weak = true;
HXDLIN( 503)			tileSpacing = point1;
            		}
HXLINE( 505)		if (::hx::IsNull( border )) {
HXLINE( 506)			 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 506)			point2->_inPool = false;
HXDLIN( 506)			 ::flixel::math::FlxBasePoint point3 = point2;
HXDLIN( 506)			point3->_weak = true;
HXDLIN( 506)			border = point3;
            		}
...
HXLINE( 509)			 ::flixel::math::FlxRect _this1 = this->region;
HXDLIN( 509)			bool result;
HXDLIN( 509)			bool result1;
HXDLIN( 509)			bool result2;
HXDLIN( 509)			if ((::Math_obj::abs((_this1->x - region->x)) <= ((Float)0.0000001))) {
HXLINE( 509)				result2 = (::Math_obj::abs((_this1->y - region->y)) <= ((Float)0.0000001));
            			}
            			else {
HXLINE( 509)				result2 = false;
            			}
HXDLIN( 509)			if (result2) {
HXLINE( 509)				result1 = (::Math_obj::abs((_this1->width - region->width)) <= ((Float)0.0000001));
            			}
            			else {
HXLINE( 509)				result1 = false;
            			}
HXDLIN( 509)			if (result1) {
HXLINE( 509)				result = (::Math_obj::abs((_this1->height - region->height)) <= ((Float)0.0000001));
            			}
            			else {
...
HXLINE( 510)			 ::flixel::math::FlxBasePoint _this2 = this->tileSize;
HXDLIN( 510)			bool result3;
HXDLIN( 510)			if ((::Math_obj::abs((_this2->x - tileSize->x)) <= ((Float)0.0000001))) {
HXLINE( 510)				result3 = (::Math_obj::abs((_this2->y - tileSize->y)) <= ((Float)0.0000001));
            			}
            			else {
HXLINE( 510)				result3 = false;
            			}
HXDLIN( 510)			if (tileSize->_weak) {
HXLINE( 510)				tileSize->put();
            			}
HXLINE( 508)			_hx_tmp2 = result3;
            		}
            		else {
HXLINE( 508)			_hx_tmp2 = false;
            		}
HXDLIN( 508)		if (_hx_tmp2) {
HXLINE( 511)			 ::flixel::math::FlxBasePoint _this3 = this->tileSpacing;
HXDLIN( 511)			bool result4;
HXDLIN( 511)			if ((::Math_obj::abs((_this3->x - tileSpacing->x)) <= ((Float)0.0000001))) {
HXLINE( 511)				result4 = (::Math_obj::abs((_this3->y - tileSpacing->y)) <= ((Float)0.0000001));
            			}
            			else {
HXLINE( 511)				result4 = false;
            			}
HXDLIN( 511)			if (tileSpacing->_weak) {
HXLINE( 511)				tileSpacing->put();
            			}
HXLINE( 508)			_hx_tmp1 = result4;
            		}
            		else {
HXLINE( 508)			_hx_tmp1 = false;
            		}
HXDLIN( 508)		if (_hx_tmp1) {
HXLINE( 512)			 ::flixel::math::FlxBasePoint _this4 = this->border;
HXDLIN( 512)			bool result5;
HXDLIN( 512)			if ((::Math_obj::abs((_this4->x - border->x)) <= ((Float)0.0000001))) {
HXLINE( 512)				result5 = (::Math_obj::abs((_this4->y - border->y)) <= ((Float)0.0000001));
            			}
            			else {
HXLINE( 512)				result5 = false;
            			}
HXDLIN( 512)			if (border->_weak) {
HXLINE( 512)				border->put();
            			}
HXDLIN( 512)			return result5;
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC5(FlxTileFrames_obj,equals,return )
 ...
 ::flixel::graphics::frames::FlxFramesCollection FlxTileFrames_obj::addBorder( ::flixel::math::FlxBasePoint border){
            	HX_GC_STACKFRAME(&_hx_pos_43be537ea661b39f_516_addBorder)
HXLINE( 517)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 517)		point->_inPool = false;
HXDLIN( 517)		 ::flixel::math::FlxBasePoint this1 = point;
HXDLIN( 517)		 ::flixel::math::FlxBasePoint point1 = this->border;
HXDLIN( 517)		{
HXLINE( 517)			Float y = point1->y;
HXDLIN( 517)			this1->set_x((this1->x + point1->x));
HXDLIN( 517)			this1->set_y((this1->y + y));
            		}
HXDLIN( 517)		{
HXLINE( 517)			 ::flixel::math::FlxBasePoint _this = point1;
HXDLIN( 517)			if (_this->_weak) {
HXLINE( 517)				_this->put();
            			}
            		}
HXDLIN( 517)		 ::flixel::math::FlxBasePoint this2 = this1;
HXDLIN( 517)		{
HXLINE( 517)			Float y1 = border->y;
HXDLIN( 517)			this2->set_x((this2->x + border->x));
HXDLIN( 517)			this2->set_y((this2->y + y1));
            		}
HXDLIN( 517)		{
HXLINE( 517)			 ::flixel::math::FlxBasePoint _this1 = border;
HXDLIN( 517)			if (_this1->_weak) {
HXLINE( 517)				_this1->put();
            			}
            		}
HXDLIN( 517)		 ::flixel::math::FlxBasePoint resultBorder = this2;
HXLINE( 518)		 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 518)		point2->_inPool = false;
HXDLIN( 518)		 ::flixel::math::FlxBasePoint this3 = point2;
HXDLIN( 518)		 ::flixel::math::FlxBasePoint p = this->tileSize;
HXDLIN( 518)		{
HXLINE( 518)			Float y2 = p->y;
HXDLIN( 518)			this3->set_x(p->x);
HXDLIN( 518)			this3->set_y(y2);
            		}
HXDLIN( 518)		{
HXLINE( 518)			 ::flixel::math::FlxBasePoint _this2 = p;
HXDLIN( 518)			if (_this2->_weak) {
HXLINE( 518)				_this2->put();
            			}
            		}
HXDLIN( 518)		 ::flixel::math::FlxBasePoint this4 = this3;
HXDLIN( 518)		Float y3 = (( (Float)(2) ) * border->y);
HXDLIN( 518)		this4->set_x((this4->x - (( (Float)(2) ) * border->x)));
HXDLIN( 518)		this4->set_y((this4->y - y3));
HXDLIN( 518)		 ::flixel::math::FlxBasePoint resultSize = this4;
...
HXLINE( 522)			resultSize = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(resultSize)) );
...
HXLINE( 527)		 ::flixel::math::FlxRect _this3 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 527)		_this3->x = ( (Float)(0) );
HXDLIN( 527)		_this3->y = ( (Float)(0) );
HXDLIN( 527)		_this3->width = ( (Float)(0) );
HXDLIN( 527)		_this3->height = ( (Float)(0) );
HXDLIN( 527)		 ::flixel::math::FlxRect rect = _this3;
HXDLIN( 527)		rect->_inPool = false;
HXDLIN( 527)		 ::flixel::math::FlxRect _this4 = rect;
HXDLIN( 527)		 ::flixel::math::FlxRect Rect = this->region;
HXDLIN( 527)		_this4->x = Rect->x;
HXDLIN( 527)		_this4->y = Rect->y;
HXDLIN( 527)		_this4->width = Rect->width;
HXDLIN( 527)		_this4->height = Rect->height;
...
HXDLIN( 527)		tileFrames->region = _this4;
HXLINE( 528)		tileFrames->atlasFrame = this->atlasFrame;
HXLINE( 529)		tileFrames->tileSize = resultSize;
HXLINE( 530)		 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 530)		point3->_inPool = false;
HXDLIN( 530)		 ::flixel::math::FlxBasePoint this5 = point3;
HXDLIN( 530)		 ::flixel::math::FlxBasePoint p1 = this->tileSpacing;
HXDLIN( 530)		{
HXLINE( 530)			Float y4 = p1->y;
HXDLIN( 530)			this5->set_x(p1->x);
HXDLIN( 530)			this5->set_y(y4);
            		}
HXDLIN( 530)		{
HXLINE( 530)			 ::flixel::math::FlxBasePoint _this5 = p1;
HXDLIN( 530)			if (_this5->_weak) {
HXLINE( 530)				_this5->put();
            			}
            		}
HXDLIN( 530)		tileFrames->tileSpacing = this5;
HXLINE( 532)		{
HXLINE( 532)			int _g = 0;
...
HXDLIN( 532)				_g = (_g + 1);
HXLINE( 534)				tileFrames->pushFrame(frame->setBorderTo(border,null()),null());
            			}
            		}
...
HXLINE( 545)		this->tileSize = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->tileSize)) );
HXLINE( 546)		this->tileSpacing = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->tileSpacing)) );
            	}


 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromBitmapAddSpacesAndBorders( ::Dynamic source, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint tileBorder, ::flixel::math::FlxRect region){
...
HXDLIN(  94)		 ::flixel::math::FlxBasePoint this1 = point;
HXDLIN(  94)		{
HXLINE(  94)			Float y = tileSize->y;
HXDLIN(  94)			this1->set_x((this1->x + tileSize->x));
HXDLIN(  94)			this1->set_y((this1->y + y));
            		}
HXDLIN(  94)		{
HXLINE(  94)			 ::flixel::math::FlxBasePoint _this = tileSize;
HXDLIN(  94)			if (_this->_weak) {
HXLINE(  94)				_this->put();
            			}
            		}
HXDLIN(  94)		 ::flixel::math::FlxBasePoint this2 = this1;
HXDLIN(  94)		this2->set_x((this2->x + (2 * borderX)));
HXDLIN(  94)		this2->set_y((this2->y + (2 * borderY)));
HXDLIN(  94)		 ::flixel::graphics::frames::FlxTileFrames tileFrames = ::flixel::graphics::frames::FlxTileFrames_obj::fromGraphic(result,this2,null(),tileSpacing);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(FlxTileFrames_obj,fromBitmapAddSpacesAndBorders,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromFrameAddSpacesAndBorders( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint tileBorder){
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxTileFrames_obj,fromFrameAddSpacesAndBorders,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromFrame( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing){
...
HXLINE( 139)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
...
HXDLIN( 156)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXLINE( 164)						tileFrames->pushFrame(frame->subFrameTo(helperRect,null()),null());
            					}
            				}
            			}
            		}
...
HXLINE( 190)					 ::flixel::math::FlxBasePoint _this = frame->sourceSize;
HXDLIN( 190)					 ::flixel::math::FlxBasePoint point = firstFrame->sourceSize;
...
HXLINE( 201)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 201)		point1->_inPool = false;
HXDLIN( 201)		 ::flixel::math::FlxBasePoint this1 = point1;
HXDLIN( 201)		 ::flixel::math::FlxBasePoint p = firstFrame->sourceSize;
HXDLIN( 201)		{
HXLINE( 201)			Float y = p->y;
HXDLIN( 201)			this1->set_x(p->x);
HXDLIN( 201)			this1->set_y(y);
            		}
HXDLIN( 201)		{
HXLINE( 201)			 ::flixel::math::FlxBasePoint _this1 = p;
HXDLIN( 201)			if (_this1->_weak) {
HXLINE( 201)				_this1->put();
            			}
            		}
HXDLIN( 201)		tileFrames->tileSize = this1;
HXLINE( 202)		 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
...
HXLINE( 206)				 ::flixel::graphics::frames::FlxFrame frame1 = Frames->__get(_g1).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 206)				_g1 = (_g1 + 1);
HXLINE( 208)				tileFrames->frames->push(frame1);
HXLINE( 210)				if (::hx::IsNotNull( frame1->name )) {
HXLINE( 211)					tileFrames->framesByName->set(frame1->name,frame1);
            				}
            			}
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxTileFrames_obj,fromAtlasByPrefix,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromGraphic( ::flixel::graphics::FlxGraphic graphic, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxRect region, ::flixel::math::FlxBasePoint tileSpacing){
...
HXDLIN( 270)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXLINE( 281)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
...
HXDLIN( 305)						 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxTileFrames_obj,fromGraphic,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromRectangle( ::Dynamic source, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxRect region, ::flixel::math::FlxBasePoint tileSpacing){
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxTileFrames_obj,fromRectangle,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::combineTileSets(::Array< ::Dynamic> bitmaps, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint spacing, ::flixel::math::FlxBasePoint border){
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxTileFrames_obj,combineTileSets,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::combineTileFrames(::Array< ::Dynamic> tileframes, ::flixel::math::FlxBasePoint spacing, ::flixel::math::FlxBasePoint border){
...
HXLINE( 430)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXLINE( 432)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(tileWidth,tileHeight);
HXDLIN( 432)		point->_inPool = false;
HXDLIN( 432)		result->tileSize = point;
HXLINE( 433)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(spaceX,spaceY);
...
HXLINE( 437)				 ::flixel::graphics::frames::FlxTileFrames collection1 = tileframes->__get(_g1).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >();
HXDLIN( 437)				_g1 = (_g1 + 1);
HXLINE( 439)				{
HXLINE( 439)					int _g2 = 0;
HXDLIN( 439)					::Array< ::Dynamic> _g3 = collection1->frames;
HXDLIN( 439)					while((_g2 < _g3->length)){
HXLINE( 439)						 ::flixel::graphics::frames::FlxFrame frame = _g3->__get(_g2).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXDLIN( 443)						 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 443)						_this1->x = X;
HXDLIN( 443)						_this1->y = Y;
HXDLIN( 443)						_this1->width = ( (Float)(tileWidth) );
HXDLIN( 443)						_this1->height = ( (Float)(tileHeight) );
HXDLIN( 443)						 ::flixel::math::FlxRect rect1 = _this1;
HXDLIN( 443)						rect1->_inPool = false;
HXDLIN( 443)						 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(tileWidth,tileHeight);
HXDLIN( 443)						point2->_inPool = false;
HXDLIN( 443)						 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN( 443)						point3->_inPool = false;
HXDLIN( 443)						result->addAtlasFrame(rect1,point2,point3,null(),null(),null(),null(),null());
...
HXLINE( 449)							 ::openfl::geom::Point destPoint2 = destPoint;
HXDLIN( 449)							destPoint2->y = (destPoint2->y + ((tileHeight + (2 * borderY)) + spaceY));
            						}
            					}
            				}
            			}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxTileFrames_obj,combineTileFrames,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::findFrame( ::flixel::graphics::FlxGraphic graphic, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxRect region, ::flixel::graphics::frames::FlxFrame atlasFrame, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint border){
...
HXDLIN( 473)		::cpp::VirtualArray tileFrames;
HXDLIN( 473)		if (::hx::IsNull( graphic->shader )) {
HXLINE( 473)			::flixel::FlxG_obj::log->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXDLIN( 473)			tileFrames = ::cpp::VirtualArray_obj::__new(0);
            		}
            		else {
HXLINE( 473)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(graphic->frameCollections->get(type)) );
...
HXDLIN( 473)			tileFrames = collections;
            		}
HXDLIN( 473)		::Array< ::Dynamic> tileFrames1 = tileFrames;
HXLINE( 475)		{
HXLINE( 475)			int _g = 0;
HXDLIN( 475)			while((_g < tileFrames1->length)){
HXLINE( 475)				 ::flixel::graphics::frames::FlxTileFrames sheet = tileFrames1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >();
HXDLIN( 475)				_g = (_g + 1);
...
::hx::ObjectPtr< FlxTileFrames_obj > FlxTileFrames_obj::__new( ::flixel::graphics::FlxGraphic parent, ::flixel::math::FlxBasePoint border) {
	::hx::ObjectPtr< FlxTileFrames_obj > __this = new FlxTileFrames_obj();
	__this->__construct(parent,border);
	return __this;
}

::hx::ObjectPtr< FlxTileFrames_obj > FlxTileFrames_obj::__alloc(::hx::Ctx *_hx_ctx, ::flixel::graphics::FlxGraphic parent, ::flixel::math::FlxBasePoint border) {
...
::hx::Val FlxTileFrames_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"tileSize") ) { tileSize=inValue.Cast<  ::flixel::math::FlxBasePoint >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"atlasFrame") ) { atlasFrame=inValue.Cast<  ::flixel::graphics::frames::FlxFrame >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"tileSpacing") ) { tileSpacing=inValue.Cast<  ::flixel::math::FlxBasePoint >(); return inValue; }
	}
...
static ::hx::StorageInfo FlxTileFrames_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::math::FlxBasePoint */ ,(int)offsetof(FlxTileFrames_obj,tileSize),HX_("tileSize",0f,c7,59,86)},
	{::hx::fsObject /*  ::flixel::math::FlxBasePoint */ ,(int)offsetof(FlxTileFrames_obj,tileSpacing),HX_("tileSpacing",f5,71,1f,31)},
