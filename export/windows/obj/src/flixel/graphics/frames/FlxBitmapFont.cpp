...
HXDLIN( 526)		::cpp::VirtualArray bitmapFonts;
HXDLIN( 526)		if (::hx::IsNull( _this->shader )) {
HXLINE( 526)			::flixel::FlxG_obj::log->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXDLIN( 526)			bitmapFonts = ::cpp::VirtualArray_obj::__new(0);
            		}
            		else {
HXLINE( 526)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(_this->frameCollections->get(type)) );
...
HXDLIN( 526)			bitmapFonts = collections;
            		}
HXDLIN( 526)		::Array< ::Dynamic> bitmapFonts1 = bitmapFonts;
HXLINE( 527)		{
HXLINE( 527)			int _g = 0;
HXDLIN( 527)			while((_g < bitmapFonts1->length)){
HXLINE( 527)				 ::flixel::graphics::frames::FlxBitmapFont font = bitmapFonts1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxBitmapFont >();
HXDLIN( 527)				_g = (_g + 1);
