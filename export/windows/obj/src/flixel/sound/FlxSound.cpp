...
HXDLIN( 300)			Float radialMultiplier1 = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::distanceTo(targetPosition,point1);
HXDLIN( 300)			radialMultiplier = (radialMultiplier1 / this->_radius);
...
HXDLIN( 302)			Float radialMultiplier2;
HXDLIN( 302)			if ((lowerBound > 1)) {
HXLINE( 302)				radialMultiplier2 = ( (Float)(1) );
            			}
            			else {
HXLINE( 302)				radialMultiplier2 = lowerBound;
            			}
HXDLIN( 302)			radialMultiplier = (( (Float)(1) ) - radialMultiplier2);
...
HXLINE( 369)						::flixel::FlxG_obj::log->advanced(((HX_("Could not find a Sound asset with an ID of '",6f,0e,1e,66) + EmbeddedSound) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            					}
            				}
            			}
            		}
