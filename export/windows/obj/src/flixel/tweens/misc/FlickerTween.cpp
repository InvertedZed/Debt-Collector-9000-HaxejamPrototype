...
HXLINE( 136)			::flixel::FlxG_obj::log->advanced(HX_("Cannot flicker with a period of 0.0 or less, using 1.0 / FlxG.updateFramerate, instead",4b,dc,b8,c3),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            		}
