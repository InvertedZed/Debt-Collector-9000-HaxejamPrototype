...
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_108_create,"flixel.FlxState","create",0x1148b519,"flixel.FlxState.create","flixel/FlxState.hx",108,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_111_draw,"flixel.FlxState","draw",0x1022c8e1,"flixel.FlxState.draw","flixel/FlxState.hx",111,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_120_openSubState,"flixel.FlxState","openSubState",0x3d5ea838,"flixel.FlxState.openSubState","flixel/FlxState.hx",120,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_130_closeSubState,"flixel.FlxState","closeSubState",0x519577cc,"flixel.FlxState.closeSubState","flixel/FlxState.hx",130,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_137_resetSubState,"flixel.FlxState","resetSubState",0x772d18e3,"flixel.FlxState.resetSubState","flixel/FlxState.hx",137,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_178_destroy,"flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",178,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_175_destroy,"flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",175,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_200_switchTo,"flixel.FlxState","switchTo",0x5e95c7ec,"flixel.FlxState.switchTo","flixel/FlxState.hx",200,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_214_startOutro,"flixel.FlxState","startOutro",0x6cd6bca6,"flixel.FlxState.startOutro","flixel/FlxState.hx",214,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_221_onFocusLost,"flixel.FlxState","onFocusLost",0x8c2b4d80,"flixel.FlxState.onFocusLost","flixel/FlxState.hx",221,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_227_onFocus,"flixel.FlxState","onFocus",0x97b2097c,"flixel.FlxState.onFocus","flixel/FlxState.hx",227,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_235_onResize,"flixel.FlxState","onResize",0x38e71fd0,"flixel.FlxState.onResize","flixel/FlxState.hx",235,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_239_tryUpdate,"flixel.FlxState","tryUpdate",0xc75023a7,"flixel.FlxState.tryUpdate","flixel/FlxState.hx",239,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_257_get_bgColor,"flixel.FlxState","get_bgColor",0xc8234a38,"flixel.FlxState.get_bgColor","flixel/FlxState.hx",257,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_263_set_bgColor,"flixel.FlxState","set_bgColor",0xd2905144,"flixel.FlxState.set_bgColor","flixel/FlxState.hx",263,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_268_get_subStateOpened,"flixel.FlxState","get_subStateOpened",0x2fcc7460,"flixel.FlxState.get_subStateOpened","flixel/FlxState.hx",268,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_277_get_subStateClosed,"flixel.FlxState","get_subStateClosed",0x1c89bb63,"flixel.FlxState.get_subStateClosed","flixel/FlxState.hx",277,0xdf96844c)
namespace flixel{

void FlxState_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_18_new)
HXLINE(  74)		this->_requestSubStateReset = false;
HXLINE(  45)		this->destroySubStates = true;
HXLINE(  39)		this->persistentDraw = true;
HXLINE(  27)		this->persistentUpdate = false;
HXLINE(  99)		super::__construct(0);
            	}
...
void FlxState_obj::create(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_108_create)
            	}
...
void FlxState_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_111_draw)
HXLINE( 112)		bool _hx_tmp;
HXDLIN( 112)		if (!(this->persistentDraw)) {
HXLINE( 112)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
...
HXLINE( 115)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 116)			this->subState->draw();
            		}
            	}


void FlxState_obj::openSubState( ::flixel::FlxSubState SubState){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_120_openSubState)
HXLINE( 121)		this->_requestSubStateReset = true;
HXLINE( 122)		this->_requestedSubState = SubState;
            	}
...
void FlxState_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_130_closeSubState)
HXDLIN( 130)		this->_requestSubStateReset = true;
            	}
...
void FlxState_obj::resetSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_137_resetSubState)
HXLINE( 139)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 141)			if (::hx::IsNotNull( this->subState->closeCallback )) {
HXLINE( 142)				this->subState->closeCallback();
            			}
HXLINE( 143)			if (::hx::IsNotNull( this->_subStateClosed )) {
HXLINE( 144)				this->_subStateClosed->dispatch(this->subState);
            			}
HXLINE( 146)			if (this->destroySubStates) {
HXLINE( 147)				this->subState->destroy();
            			}
            		}
HXLINE( 151)		this->subState = this->_requestedSubState;
HXLINE( 152)		this->_requestedSubState = null();
HXLINE( 154)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 157)			if (!(this->persistentUpdate)) {
HXLINE( 158)				::flixel::FlxG_obj::inputs->onStateSwitch();
            			}
HXLINE( 160)			this->subState->_parentState = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 162)			if (!(this->subState->_created)) {
HXLINE( 164)				this->subState->_created = true;
HXLINE( 165)				this->subState->create();
            			}
HXLINE( 167)			if (::hx::IsNotNull( this->subState->openCallback )) {
HXLINE( 168)				this->subState->openCallback();
            			}
HXLINE( 169)			if (::hx::IsNotNull( this->_subStateOpened )) {
HXLINE( 170)				this->_subStateOpened->dispatch(this->subState);
            			}
            		}
            	}
...
void FlxState_obj::destroy(){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::flixel::FlxState _hx_run(){
            			HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_178_destroy)
HXLINE( 178)			HX_STACK_DO_THROW(HX_("Attempting to resetState while the current state is destroyed",9b,d7,fc,3b));
HXDLIN( 178)			return null();
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_175_destroy)
HXLINE( 176)		this->_constructor = ::flixel::util::typeLimit::_NextState::NextState_Impl__obj::fromMaker( ::Dynamic(new _hx_Closure_0()));
HXLINE( 180)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateOpened);
HXLINE( 181)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateClosed);
HXLINE( 183)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 185)			this->subState->destroy();
HXLINE( 186)			this->subState = null();
            		}
...
bool FlxState_obj::switchTo( ::flixel::FlxState nextState){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_200_switchTo)
...
void FlxState_obj::startOutro( ::Dynamic onOutroComplete){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_214_startOutro)
HXDLIN( 214)		onOutroComplete();
            	}
...
void FlxState_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_221_onFocusLost)
            	}
...
void FlxState_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_227_onFocus)
            	}
...
void FlxState_obj::onResize(int Width,int Height){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_235_onResize)
            	}
...
void FlxState_obj::tryUpdate(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_239_tryUpdate)
HXLINE( 240)		bool _hx_tmp;
HXDLIN( 240)		if (!(this->persistentUpdate)) {
HXLINE( 240)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
HXLINE( 240)			_hx_tmp = true;
            		}
HXDLIN( 240)		if (_hx_tmp) {
HXLINE( 241)			this->update(elapsed);
            		}
HXLINE( 243)		if (this->_requestSubStateReset) {
HXLINE( 245)			this->_requestSubStateReset = false;
HXLINE( 246)			this->resetSubState();
            		}
HXLINE( 248)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 250)			this->subState->tryUpdate(elapsed);
            		}
            	}
...
int FlxState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_257_get_bgColor)
HXDLIN( 257)		return ::flixel::FlxG_obj::cameras->get_bgColor();
            	}
...
int FlxState_obj::set_bgColor(int Value){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_263_set_bgColor)
HXDLIN( 263)		return ::flixel::FlxG_obj::cameras->set_bgColor(Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxState_obj,set_bgColor,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal1 FlxState_obj::get_subStateOpened(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_268_get_subStateOpened)
HXLINE( 269)		if (::hx::IsNull( this->_subStateOpened )) {
HXLINE( 270)			this->_subStateOpened =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 272)		return this->_subStateOpened;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxState_obj,get_subStateOpened,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal1 FlxState_obj::get_subStateClosed(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_277_get_subStateClosed)
HXLINE( 278)		if (::hx::IsNull( this->_subStateClosed )) {
HXLINE( 279)			this->_subStateClosed =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 281)		return this->_subStateClosed;
            	}
