...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1253_hurt,"flixel.FlxObject","hurt",0x21beeabe,"flixel.FlxObject.hurt","flixel/FlxObject.hx",1253,0xf0fe0d80)
...
HXLINE( 746)		this->health = ((Float)1);
...
HXLINE(1105)		{
HXLINE(1105)			 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(1105)			if (_this->_weak) {
HXLINE(1105)				_this->put();
            			}
            		}
...
void FlxObject_obj::hurt(Float damage){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1253_hurt)
HXLINE(1254)		this->health = (this->health - damage);
HXLINE(1255)		if ((this->health <= 0)) {
HXLINE(1256)			this->kill();
            		}
            	}
