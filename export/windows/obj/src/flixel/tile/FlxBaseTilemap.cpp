...
HXLINE(1400)			::flixel::FlxG_obj::log->advanced((((HX_("Cannot setTileProperties of ",cf,3d,52,94) + rangeDisplay) + HX_(" when tilemap does not contain any tiles.",c5,3c,2f,55)) + HX_(" This may be due to an invalid graphic.",a9,75,60,06)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
HXLINE(1402)			return;
            		}
...
HXLINE(1408)			::flixel::FlxG_obj::log->advanced(((((HX_("Cannot setTileProperties of ",cf,3d,52,94) + rangeDisplay1) + HX_(" when there are only ",66,4c,3f,59)) + end) + HX_(" tiles.",29,af,d7,50)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
HXLINE(1409)			return;
            		}
HXLINE(1412)		{
...
HXLINE(1604)				camera = ::flixel::FlxG_obj::camera;
            			}
HXLINE(1606)			{
