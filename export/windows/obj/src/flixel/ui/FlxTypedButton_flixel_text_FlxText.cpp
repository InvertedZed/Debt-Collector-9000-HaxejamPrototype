...
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_623_set_alpha,"flixel.ui.FlxTypedButton_flixel_text_FlxText","set_alpha",0x6645d4f6,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_alpha","flixel/ui/FlxButton.hx",623,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_630_set_x,"flixel.ui.FlxTypedButton_flixel_text_FlxText","set_x",0x2df28210,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_x","flixel/ui/FlxButton.hx",630,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_637_set_y,"flixel.ui.FlxTypedButton_flixel_text_FlxText","set_y",0x2df28211,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_y","flixel/ui/FlxButton.hx",637,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_645_get_justReleased,"flixel.ui.FlxTypedButton_flixel_text_FlxText","get_justReleased",0x234d62fd,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_justReleased","flixel/ui/FlxButton.hx",645,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_650_get_released,"flixel.ui.FlxTypedButton_flixel_text_FlxText","get_released",0x17b1c6b1,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_released","flixel/ui/FlxButton.hx",650,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_655_get_pressed,"flixel.ui.FlxTypedButton_flixel_text_FlxText","get_pressed",0x60818f2e,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_pressed","flixel/ui/FlxButton.hx",655,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_660_get_justPressed,"flixel.ui.FlxTypedButton_flixel_text_FlxText","get_justPressed",0x5f690062,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_justPressed","flixel/ui/FlxButton.hx",660,0xc64cf442)
namespace flixel{
namespace ui{
...
HXDLIN( 475)			Float _hx_tmp2 = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::distanceTo(justPressedPosition,pointer->getViewPosition(null(),point1));
...
HXLINE( 618)		this->updateLabelPosition();
HXLINE( 619)		return this->status;
            	}
...
Float FlxTypedButton_flixel_text_FlxText_obj::set_alpha(Float Value){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_623_set_alpha)
HXLINE( 624)		this->super::set_alpha(Value);
HXLINE( 625)		this->updateLabelAlpha();
HXLINE( 626)		return this->alpha;
            	}


Float FlxTypedButton_flixel_text_FlxText_obj::set_x(Float Value){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_630_set_x)
HXLINE( 631)		this->super::set_x(Value);
HXLINE( 632)		this->updateLabelPosition();
HXLINE( 633)		return this->x;
            	}


Float FlxTypedButton_flixel_text_FlxText_obj::set_y(Float Value){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_637_set_y)
HXLINE( 638)		this->super::set_y(Value);
HXLINE( 639)		this->updateLabelPosition();
HXLINE( 640)		return this->y;
            	}


bool FlxTypedButton_flixel_text_FlxText_obj::get_justReleased(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_645_get_justReleased)
HXDLIN( 645)		return (this->input->current == -1);
            	}
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_released(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_650_get_released)
HXDLIN( 650)		 ::flixel::input::FlxInput _this = this->input;
HXDLIN( 650)		if ((_this->current != 0)) {
HXDLIN( 650)			return (_this->current == -1);
            		}
            		else {
HXDLIN( 650)			return true;
            		}
HXDLIN( 650)		return false;
            	}
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_pressed(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_655_get_pressed)
HXDLIN( 655)		 ::flixel::input::FlxInput _this = this->input;
HXDLIN( 655)		if ((_this->current != 1)) {
HXDLIN( 655)			return (_this->current == 2);
            		}
            		else {
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_justPressed(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_660_get_justPressed)
HXDLIN( 660)		return (this->input->current == 2);
            	}
