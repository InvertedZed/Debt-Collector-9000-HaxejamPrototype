...
HX_DEFINE_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_686_new,"flixel.ui._FlxButton.FlxButtonEvent","new",0xea40fb69,"flixel.ui._FlxButton.FlxButtonEvent.new","flixel/ui/FlxButton.hx",686,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_698_destroy,"flixel.ui._FlxButton.FlxButtonEvent","destroy",0x72801083,"flixel.ui._FlxButton.FlxButtonEvent.destroy","flixel/ui/FlxButton.hx",698,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_710_fire,"flixel.ui._FlxButton.FlxButtonEvent","fire",0x0954508d,"flixel.ui._FlxButton.FlxButtonEvent.fire","flixel/ui/FlxButton.hx",710,0xc64cf442)
namespace flixel{
namespace ui{
namespace _FlxButton{

void FlxButtonEvent_obj::__construct( ::Dynamic Callback, ::flixel::sound::FlxSound sound){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_686_new)
HXLINE( 687)		this->callback = Callback;
HXLINE( 690)		this->sound = sound;
            	}
...
void FlxButtonEvent_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_698_destroy)
HXLINE( 699)		this->callback = null();
HXLINE( 702)		this->sound = ( ( ::flixel::sound::FlxSound)(::flixel::util::FlxDestroyUtil_obj::destroy(this->sound)) );
            	}
...
void FlxButtonEvent_obj::fire(){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_710_fire)
HXLINE( 711)		if (::hx::IsNotNull( this->callback )) {
HXLINE( 712)			this->callback();
            		}
HXLINE( 715)		if (::hx::IsNotNull( this->sound )) {
HXLINE( 716)			this->sound->play(true,null(),null());
            		}
            	}
...
::hx::ObjectPtr< FlxButtonEvent_obj > FlxButtonEvent_obj::__new( ::Dynamic Callback, ::flixel::sound::FlxSound sound) {
	::hx::ObjectPtr< FlxButtonEvent_obj > __this = new FlxButtonEvent_obj();
	__this->__construct(Callback,sound);
	return __this;
}

::hx::ObjectPtr< FlxButtonEvent_obj > FlxButtonEvent_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic Callback, ::flixel::sound::FlxSound sound) {
...
static ::hx::StorageInfo FlxButtonEvent_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::sound::FlxSound */ ,(int)offsetof(FlxButtonEvent_obj,sound),HX_("sound",cf,8c,cc,80)},
	{ ::hx::fsUnknown, 0, null()}
};
