...
HX_LOCAL_STACK_FRAME(_hx_pos_97671fefbd3e0550_230_toString,"haxe.ds.BalancedTree","toString",0x3e62fddd,"haxe.ds.BalancedTree.toString","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",230,0x9022da28)
...
::String BalancedTree_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_97671fefbd3e0550_230_toString)
HXDLIN( 230)		if (::hx::IsNull( this->root )) {
HXDLIN( 230)			return HX_("[]",a2,4f,00,00);
            		}
            		else {
HXDLIN( 230)			return ((HX_("[",5b,00,00,00) + this->root->toString()) + HX_("]",5d,00,00,00));
            		}
