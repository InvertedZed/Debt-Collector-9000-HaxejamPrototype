...
#endif
#ifndef INCLUDED___ASSET__OPENFL__assets_fonts_default_ttf
#include <__ASSET__OPENFL__assets_fonts_default_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_default_ttf
#include <__ASSET__assets_fonts_default_ttf.h>
#endif
...
::openfl::utils::_internal::format::amf3::AMF3Value_obj::__register();
::openfl::utils::_internal::format::amf::AMFValue_obj::__register();
...
::game::ingame::ControlEnum_obj::__register();
::game::ingame::BackdropBlitMode_obj::__register();
::flixel::util::FlxVerticalAlign_obj::__register();
::flixel::util::FlxSaveStatus_obj::__register();
::flixel::util::LoadFailureType_obj::__register();
::flixel::util::LoadResult_obj::__register();
...
::flixel::text::TypingCommand_obj::__register();
::flixel::text::MoveCursorAction_obj::__register();
::flixel::text::TypingAction_obj::__register();
::flixel::text::FlxInputTextFilterMode_obj::__register();
::flixel::_hx_system::debug::FlxDebuggerLayout_obj::__register();
::flixel::path::FlxPathSimplifier_obj::__register();
::flixel::path::FlxPathAnchorMode_obj::__register();
::flixel::input::gamepad::mappings::Manufacturer_obj::__register();
::flixel::input::gamepad::FlxGamepadMappedInput_obj::__register();
::flixel::input::gamepad::FlxGamepadAcceptMode_obj::__register();
...
::flixel::addons::input::GroupConflictsResults_obj::__register();
::flixel::addons::input::DigitalEvent_obj::__register();
::flixel::addons::input::FlxDeviceIDRaw_obj::__register();
::flixel::addons::input::FlxMappedInputType_obj::__register();
::flixel::addons::input::FlxControlMappedInput_obj::__register();
::flixel::addons::input::FlxMouseInputType_obj::__register();
::flixel::addons::input::FlxVirtualPadInputType_obj::__register();
::flixel::addons::input::FlxGamepadInputType_obj::__register();
::flixel::addons::input::FlxKeyInputType_obj::__register();
::flixel::addons::input::FlxControlInputTypeRaw_obj::__register();
...
::openfl::display::TileData_obj::__register();
...
::lime::_hx_system::JobData_obj::__register();
...
::lime::app::FutureWork_obj::__register();
...
::flixel::text::FlxInputText_obj::__register();
...
::flixel::path::_FlxBasePath::FlxPathDirection_Impl__obj::__register();
...
::flixel::input::gamepad::id::_XInputID::XInputID_Impl__obj::__register();
::flixel::input::gamepad::id::_WiiRemoteID::WiiRemoteID_Impl__obj::__register();
::flixel::input::gamepad::id::_SwitchProID::SwitchProID_Impl__obj::__register();
::flixel::input::gamepad::id::_SwitchJoyconRightID::SwitchJoyconRightID_Impl__obj::__register();
::flixel::input::gamepad::id::_SwitchJoyconLeftID::SwitchJoyconLeftID_Impl__obj::__register();
::flixel::input::gamepad::id::_PSVitaID::PSVitaID_Impl__obj::__register();
::flixel::input::gamepad::id::_PS4ID::PS4ID_Impl__obj::__register();
::flixel::input::gamepad::id::_OUYAID::OUYAID_Impl__obj::__register();
::flixel::input::gamepad::id::_MayflashWiiRemoteID::MayflashWiiRemoteID_Impl__obj::__register();
::flixel::input::gamepad::id::_MFiID::MFiID_Impl__obj::__register();
::flixel::input::gamepad::id::_LogitechID::LogitechID_Impl__obj::__register();
...
::flixel::addons::input::FlxRepeatInput_obj::__register();
::flixel::addons::input::_FlxControlInputType::FlxControlInputType_Impl__obj::__register();
...
::backend::AssetManager_obj::__register();
::Xml_obj::__register();
...
::openfl::utils::_internal::format::amf3::AMF3ReaderInput_obj::__register();
::openfl::utils::_internal::format::amf3::AMF3Reader_obj::__register();
::openfl::utils::_internal::format::amf::AMFWriter_obj::__register();
::openfl::utils::_internal::format::amf::AMFTools_obj::__register();
::openfl::utils::_internal::format::amf::AMFReader_obj::__register();
::openfl::utils::QName_obj::__register();
::openfl::utils::Namespace_obj::__register();
::openfl::utils::IExternalizable_obj::__register();
...
::lime::_hx_system::JSAsync_obj::__register();
::lime::_hx_system::JobList_obj::__register();
::lime::_hx_system::_ThreadPool::PseudoEvent_Impl__obj::__register();
::lime::_hx_system::WorkOutput_obj::__register();
...
::lime::math::CairoMatrix3_obj::__register();
...
::lime::app::_Event_lime_system_State_Void_obj::__register();
...
::game::states::TestState_obj::__register();
::game::ingame::PlayerControls_obj::__register();
::game::ingame::Player_obj::__register();
::game::ingame::Background_obj::__register();
::game::ingame::Backdrop_obj::__register();
...
::flixel::text::FlxInputTextManager_obj::__register();
::flixel::text::IFlxInputText_obj::__register();
...
::flixel::path::_FlxPath::AnchorTools_obj::__register();
::flixel::path::FlxPathDrawData_obj::__register();
::flixel::path::FlxTypedBasePath_obj::__register();
...
::flixel::input::gamepad::mappings::FlxTypedGamepadMapping_obj::__register();
...
::flixel::input::gamepad::_FlxGamepadMappedInput::FlxGamepadMappedInputTools_obj::__register();
::flixel::input::gamepad::FlxGamepadButton_obj::__register();
::flixel::input::gamepad::FlxTypedGamepadAnalogStick_obj::__register();
...
::flixel::addons::input::_FlxDigitalSet::FlxControlDigital_Impl__obj::__register();
::flixel::addons::input::FlxControlRepeatDigital_obj::__register();
::flixel::input::actions::FlxActionDigital_obj::__register();
::flixel::addons::input::FlxDigitalSet_obj::__register();
::flixel::addons::input::GroupConflict_obj::__register();
::flixel::addons::input::_FlxControls::GroupTools_obj::__register();
::flixel::addons::input::_FlxControls::DigitalEventTools_obj::__register();
::flixel::addons::input::_FlxControls::FlxDeviceID_Impl__obj::__register();
::flixel::addons::input::_FlxControls::VirtualPadInputProxy_obj::__register();
::flixel::input::IFlxInput_obj::__register();
::flixel::addons::input::FlxControls_obj::__register();
::flixel::addons::input::_FlxControls::ActionManager_obj::__register();
::flixel::input::actions::FlxActionManager_obj::__register();
::flixel::input::IFlxInputManager_obj::__register();
::flixel::addons::input::FlxControlMappedInputTools_obj::__register();
::flixel::addons::input::_FlxAnalogSet::FlxAnalogSet_Fields__obj::__register();
::flixel::addons::input::_FlxAnalogSet::AnalogMouseWheelDelta_obj::__register();
::flixel::addons::input::_FlxAnalogSet::AnalogMousePosition_obj::__register();
::flixel::input::actions::FlxActionInputAnalogMousePosition_obj::__register();
::flixel::addons::input::_FlxAnalogSet::AnalogMouseMove_obj::__register();
::flixel::addons::input::_FlxAnalogSet::AnalogMouseDrag_obj::__register();
...
::flixel::addons::input::_FlxAnalogSet::Analog2DVPad_obj::__register();
::flixel::addons::input::_FlxAnalogSet::Analog1DVPad_obj::__register();
::flixel::addons::input::_FlxAnalogSet::Analog2DGamepad_obj::__register();
::flixel::addons::input::_FlxAnalogSet::AnalogGamepadStick_obj::__register();
::flixel::input::actions::FlxActionInputAnalogGamepad_obj::__register();
::flixel::addons::input::_FlxAnalogSet::Analog1DGamepad_obj::__register();
::flixel::addons::input::_FlxAnalogSet::Analog2DKeys_obj::__register();
::flixel::addons::input::_FlxAnalogSet::Analog1DKeys_obj::__register();
::flixel::addons::input::_FlxAnalogSet::ActionInputAnalog_obj::__register();
::flixel::input::actions::FlxActionInput_obj::__register();
::flixel::addons::input::FlxControlAnalog_obj::__register();
::flixel::input::actions::FlxActionAnalog_obj::__register();
::flixel::input::actions::FlxAction_obj::__register();
::flixel::addons::input::FlxAnalogDirections2D_obj::__register();
::flixel::addons::input::_FlxAnalogSet::FlxAnalogDirections1D_Impl__obj::__register();
::flixel::addons::input::FlxAnalogSet_obj::__register();
::flixel::addons::input::_FlxAnalogSet::FlxAnalogSet2DBase_Impl__obj::__register();
::flixel::addons::input::_FlxAnalogSet::FlxAnalogSet2D_Impl__obj::__register();
::flixel::addons::input::_FlxAnalogSet::FlxAnalogSet1DBase_Impl__obj::__register();
::flixel::addons::input::_FlxAnalogSet::FlxAnalogSet1D_Impl__obj::__register();
...
::backend::helpers::DebugStats_obj::__register();
::backend::GameSprite_obj::__register();
::flixel::addons::effects::FlxSkewedSprite_obj::__register();
::backend::Camera_obj::__register();
::lime::utils::ArrayBufferView_obj::__register();
::lime::math::_Matrix3::Matrix3_Impl__obj::__register();
...
::backend::CacheSound_obj::__register();
::backend::CacheImage_obj::__register();
::backend::ObjectCache_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_default_ttf_obj::__register();
::__ASSET__assets_fonts_default_ttf_obj::__register();
::lime::graphics::Image_obj::__register();
::lime::text::Font_obj::__register();
::haxe::io::Bytes_obj::__register();
::ManifestResources_obj::__register();
::Lambda_obj::__register();
::_FlxDigitalSet__game_ingame_ControlEnum::FlxDigitalSet__game_ingame_ControlEnum_Impl__obj::__register();
::EReg_obj::__register();
::Date_obj::__register();
...
::openfl::utils::_internal::format::amf3::AMF3Value_obj::__boot();
::openfl::utils::_internal::format::amf::AMFValue_obj::__boot();
...
::game::ingame::ControlEnum_obj::__boot();
::game::ingame::BackdropBlitMode_obj::__boot();
::flixel::util::FlxVerticalAlign_obj::__boot();
::flixel::util::FlxSaveStatus_obj::__boot();
::flixel::util::LoadFailureType_obj::__boot();
::flixel::util::LoadResult_obj::__boot();
...
::flixel::text::TypingCommand_obj::__boot();
::flixel::text::MoveCursorAction_obj::__boot();
::flixel::text::TypingAction_obj::__boot();
::flixel::text::FlxInputTextFilterMode_obj::__boot();
::flixel::_hx_system::debug::FlxDebuggerLayout_obj::__boot();
::flixel::path::FlxPathSimplifier_obj::__boot();
::flixel::path::FlxPathAnchorMode_obj::__boot();
::flixel::input::gamepad::mappings::Manufacturer_obj::__boot();
::flixel::input::gamepad::FlxGamepadMappedInput_obj::__boot();
::flixel::input::gamepad::FlxGamepadAcceptMode_obj::__boot();
...
::flixel::addons::input::GroupConflictsResults_obj::__boot();
::flixel::addons::input::DigitalEvent_obj::__boot();
::flixel::addons::input::FlxDeviceIDRaw_obj::__boot();
::flixel::addons::input::FlxMappedInputType_obj::__boot();
::flixel::addons::input::FlxControlMappedInput_obj::__boot();
::flixel::addons::input::FlxMouseInputType_obj::__boot();
::flixel::addons::input::FlxVirtualPadInputType_obj::__boot();
::flixel::addons::input::FlxGamepadInputType_obj::__boot();
::flixel::addons::input::FlxKeyInputType_obj::__boot();
::flixel::addons::input::FlxControlInputTypeRaw_obj::__boot();
...
::Xml_obj::__boot();
::backend::AssetManager_obj::__boot();
...
::flixel::addons::input::_FlxControlInputType::FlxControlInputType_Impl__obj::__boot();
::flixel::addons::input::FlxRepeatInput_obj::__boot();
...
::flixel::input::gamepad::id::_LogitechID::LogitechID_Impl__obj::__boot();
::flixel::input::gamepad::id::_MFiID::MFiID_Impl__obj::__boot();
::flixel::input::gamepad::id::_MayflashWiiRemoteID::MayflashWiiRemoteID_Impl__obj::__boot();
::flixel::input::gamepad::id::_OUYAID::OUYAID_Impl__obj::__boot();
::flixel::input::gamepad::id::_PS4ID::PS4ID_Impl__obj::__boot();
::flixel::input::gamepad::id::_PSVitaID::PSVitaID_Impl__obj::__boot();
::flixel::input::gamepad::id::_SwitchJoyconLeftID::SwitchJoyconLeftID_Impl__obj::__boot();
::flixel::input::gamepad::id::_SwitchJoyconRightID::SwitchJoyconRightID_Impl__obj::__boot();
::flixel::input::gamepad::id::_SwitchProID::SwitchProID_Impl__obj::__boot();
::flixel::input::gamepad::id::_WiiRemoteID::WiiRemoteID_Impl__obj::__boot();
::flixel::input::gamepad::id::_XInputID::XInputID_Impl__obj::__boot();
...
::flixel::path::_FlxBasePath::FlxPathDirection_Impl__obj::__boot();
...
::flixel::text::FlxInputText_obj::__boot();
...
::lime::app::FutureWork_obj::__boot();
...
::lime::_hx_system::ThreadPool_obj::__boot();
::lime::_hx_system::JobData_obj::__boot();
...
::openfl::display::TileData_obj::__boot();
