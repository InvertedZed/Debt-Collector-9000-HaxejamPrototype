...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("UntitledGameJamEntry",73,69,02,6c),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("67",41,2f,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("FuckassCorp",54,88,aa,ba));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("UntitledGameJamEntry",73,69,02,6c));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Untitled Game Jam Entry",95,ad,39,05));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),1024)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),768)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Untitled Game Jam Entry",95,ad,39,05))
