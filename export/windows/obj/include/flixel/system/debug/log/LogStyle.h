...
class HXCPP_CLASS_ATTRIBUTES LogStyle_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct(::String __o_prefix,::String __o_color,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_bold,::hx::Null< bool >  __o_italic,::hx::Null< bool >  __o_underlined,::String errorSound,::hx::Null< bool >  __o_openConsole, ::Dynamic callbackFunction, ::Dynamic callback,::hx::Null< bool >  __o_throwException);
		...
		static ::hx::ObjectPtr< LogStyle_obj > __new(::String __o_prefix,::String __o_color,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_bold,::hx::Null< bool >  __o_italic,::hx::Null< bool >  __o_underlined,::String errorSound,::hx::Null< bool >  __o_openConsole, ::Dynamic callbackFunction, ::Dynamic callback,::hx::Null< bool >  __o_throwException);
		static ::hx::ObjectPtr< LogStyle_obj > __alloc(::hx::Ctx *_hx_ctx,::String __o_prefix,::String __o_color,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_bold,::hx::Null< bool >  __o_italic,::hx::Null< bool >  __o_underlined,::String errorSound,::hx::Null< bool >  __o_openConsole, ::Dynamic callbackFunction, ::Dynamic callback,::hx::Null< bool >  __o_throwException);
		...
		Dynamic callbackFunction_dyn() { return callbackFunction;}
		 ::flixel::util::_FlxSignal::FlxSignal1 onLog;
		bool throwException;
