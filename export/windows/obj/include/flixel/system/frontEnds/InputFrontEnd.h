...
class HXCPP_CLASS_ATTRIBUTES InputFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("InputFrontEnd",bc,9c,cc,29); }
		 ...
		 ::game::ingame::PlayerControls addInput_game_ingame_PlayerControls( ::game::ingame::PlayerControls input);
		::Dynamic addInput_game_ingame_PlayerControls_dyn();

		 ::Dynamic addUniqueType_add_T( ::Dynamic input);
		::Dynamic addUniqueType_add_T_dyn();

		 ::flixel::input::gamepad::FlxGamepadManager addInput_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager input);
		::Dynamic addInput_flixel_input_gamepad_FlxGamepadManager_dyn();
