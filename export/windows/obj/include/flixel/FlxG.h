...
class HXCPP_CLASS_ATTRIBUTES FlxG_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::flixel::_hx_system::frontEnds::AssetFrontEnd assets;
		...
		static void init( ::flixel::FlxGame game,int width,int height);
		...
		static  ::flixel::_hx_system::scaleModes::BaseScaleMode set_scaleMode( ::flixel::_hx_system::scaleModes::BaseScaleMode value);
		...
		static int set_updateFramerate(int value);
		static ::Dynamic set_updateFramerate_dyn();

		static int set_drawFramerate(int value);
