...
class HXCPP_CLASS_ATTRIBUTES FlxObject_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		static bool processCheckTilemap( ::flixel::FlxObject object1, ::flixel::FlxObject object2, ::Dynamic func, ::flixel::math::FlxBasePoint position,::hx::Null< bool >  isCollision);
		static ::Dynamic processCheckTilemap_dyn();
		...
		static bool separateXHelper( ::flixel::FlxObject object1, ::flixel::FlxObject object2);
		static ::Dynamic separateXHelper_dyn();

		static bool separateYHelper( ::flixel::FlxObject object1, ::flixel::FlxObject object2);
		static ::Dynamic separateYHelper_dyn();

		static void legacySeparateX( ::flixel::FlxObject object1, ::flixel::FlxObject object2,Float overlap);
		static ::Dynamic legacySeparateX_dyn();

		static void legacySeparateY( ::flixel::FlxObject object1, ::flixel::FlxObject object2,Float overlap);
		static ::Dynamic legacySeparateY_dyn();
		...
		static bool updateTouchingFlagsXHelper( ::flixel::FlxObject object1, ::flixel::FlxObject object2);
		static ::Dynamic updateTouchingFlagsXHelper_dyn();
		...
		static bool updateTouchingFlagsYHelper( ::flixel::FlxObject object1, ::flixel::FlxObject object2);
		static ::Dynamic updateTouchingFlagsYHelper_dyn();
