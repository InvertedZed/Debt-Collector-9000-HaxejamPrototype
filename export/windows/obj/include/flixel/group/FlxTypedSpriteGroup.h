...
class HXCPP_CLASS_ATTRIBUTES FlxTypedSpriteGroup_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void transformChildren_openfl_display_BlendMode( ::Dynamic Function, ::Dynamic Value);
		...
		Float findMinX();
		::Dynamic findMinX_dyn();

		Float findMinXHelper();
		::Dynamic findMinXHelper_dyn();

		Float findMaxX();
		::Dynamic findMaxX_dyn();

		Float findMaxXHelper();
		::Dynamic findMaxXHelper_dyn();
		...
		Float findMinY();
		::Dynamic findMinY_dyn();

		Float findMinYHelper();
		::Dynamic findMinYHelper_dyn();

		Float findMaxY();
		::Dynamic findMaxY_dyn();

		Float findMaxYHelper();
		::Dynamic findMaxYHelper_dyn();
		...
		void offsetTransform( ::flixel::FlxSprite Sprite, ::flixel::math::FlxBasePoint Offset);
		::Dynamic offsetTransform_dyn();

		void originTransform( ::flixel::FlxSprite Sprite, ::flixel::math::FlxBasePoint Origin);
		::Dynamic originTransform_dyn();

		void scaleTransform( ::flixel::FlxSprite Sprite, ::flixel::math::FlxBasePoint Scale);
		::Dynamic scaleTransform_dyn();

		void scrollFactorTransform( ::flixel::FlxSprite Sprite, ::flixel::math::FlxBasePoint ScrollFactor);
		...
		void offsetCallback( ::flixel::math::FlxBasePoint Offset);
		::Dynamic offsetCallback_dyn();

		void originCallback( ::flixel::math::FlxBasePoint Origin);
		::Dynamic originCallback_dyn();

		void scaleCallback( ::flixel::math::FlxBasePoint Scale);
		::Dynamic scaleCallback_dyn();

		void scrollFactorCallback( ::flixel::math::FlxBasePoint ScrollFactor);
		...
		::Array< ::Dynamic> get__sprites();
		::Dynamic get__sprites_dyn();
