...
class HXCPP_CLASS_ATTRIBUTES FlxPath_obj : public  ::flixel::path::FlxTypedBasePath_obj
{
	...
	public:
		...
		int get_nodeIndex();
		::Dynamic get_nodeIndex_dyn();

		bool set_immovable(bool value);
		::Dynamic set_immovable_dyn();

		bool set_autoCenter(bool value);
		::Dynamic set_autoCenter_dyn();

		bool get_autoCenter();
		::Dynamic get_autoCenter_dyn();

		int get__inc();
		::Dynamic get__inc_dyn();

		int set__inc(int value);
		::Dynamic set__inc_dyn();

		int get__mode();
		::Dynamic get__mode_dyn();

		int set__mode(int value);
		::Dynamic set__mode_dyn();

		 ::flixel::FlxObject get_object();
		::Dynamic get_object_dyn();

		 ::flixel::FlxObject set_object( ::flixel::FlxObject value);
		::Dynamic set_object_dyn();
